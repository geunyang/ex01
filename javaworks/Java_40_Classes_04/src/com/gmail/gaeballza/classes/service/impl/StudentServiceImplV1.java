package com.gmail.gaeballza.classes.service.impl;
...
public class StudentServiceImplV1 implements StudentService {
	...
	public void loadStudent() {
		...
		while (scan.hasNext()) {
			...
			stList[index++] = stVO;
		} // end while 여기를 지나면 stList에 모든 데이터가 담겨 있을것이다
		this.printStudents();

	}  // end loadStudent
	// StudentServiceImplV1 에서 stLlist에 담긴 데이터들을 확인하기 위하여 내부용으로 만든 method
